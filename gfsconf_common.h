...
#define GFSCONFIGTAGSCOUNT 167  // tags-1 (release not included)
...
// Define NEXFSPHONEHOMEENABLED
int NEXFSPHONEHOMEENABLED;
#define DEFAULTNEXFSPHONEHOMEENABLED 1
#define NEXFSPHONEHOMEENABLEDTAG "NEXFSPHONEHOMEENABLED"
#define NEXFSPHONEHOMEENABLEDHELP "Enable or disable the Nexfs phone home feature"
#define NEXFSPHONEHOMEENABLEDVALIDATESTRING 0
#define NEXFSPHONEHOMEENABLEDVALIDATEMIN 0
#define NEXFSPHONEHOMEENABLEDVALIDATEMAX 1
#define NEXFSPHONEHOMEENABLEDRESTARTREQUIRED 0

// Define NEXFSPHONEHOMELOCATION
char NEXFSPHONEHOMELOCATION[128];
#define DEFAULTNEXFSPHONEHOMELOCATION "https://www.nexustorage.com/_functions/logRequest?"
#define NEXFSPHONEHOMELOCATIONTAG "NEXFSPHONEHOMELOCATION"
#define NEXFSPHONEHOMELOCATIONHELP "The URL for the Nexfs phone home feature"
#define NEXFSPHONEHOMELOCATIONVALIDATESTRING 1
#define NEXFSPHONEHOMELOCATIONVALIDATEMIN 0
#define NEXFSPHONEHOMELOCATIONVALIDATEMAX 128
#define NEXFSPHONEHOMELOCATIONRESTARTREQUIRED 0
...
// Define NEXFSSERVERUUID
char NEXFSSERVERUUID[64];
#define DEFAULTNEXFSSERVERUUID ""
#define NEXFSSERVERUUIDTAG "NEXFS SERVER UUID"
#define NEXFSSERVERUUIDHELP "The UUID for the Nexfs server"
#define NEXFSSERVERUUIDVALIDATESTRING 1
#define NEXFSSERVERUUIDVALIDATEMIN 0
#define NEXFSSERVERUUIDVALIDATEMAX 64
#define NEXFSSERVERUUIDRESTARTREQUIRED 0

// Define NEXFSREGION
char NEXFSREGION[64];
#define DEFAULTNEXFSREGION "us-east-1"
#define NEXFSREGIONTAG "NEXFSREGION"
#define NEXFSREGIONHELP "Nexfs server cluster region & Content Server (S3) region"
...
#define DEFAULTCONTENTWEBSERVERPORT "443"
...
#define WSMAXREQUESTHEADERSTAG "WSMAXREQUESTHEADERS"
#define WSMAXREQUESTHEADERSHELP "The maximum number of request headers"
#define WSMAXREQUESTHEADERSVALIDATESTRING 0
#define WSMAXREQUESTHEADERSVALIDATEMIN 1
#define WSMAXREQUESTHEADERSVALIDATEMAX 1024
#define WSMAXREQUESTHEADERSRESTARTREQUIRED 1

// Define WSOPTARGMEMORYSIZE
int WSOPTARGMEMORYSIZE;
#define DEFAULTWSOPTARGMEMORYSIZE 8192
#define WSOPTARGMEMORYSIZETAG "WSOPTARGMEMORYSIZE"
#define WSOPTARGMEMORYSIZEHELP "The memory block to use to store the cookies, get args, and post args"
#define WSOPTARGMEMORYSIZEVALIDATESTRING 0
#define WSOPTARGMEMORYSIZEVALIDATEMIN 1024
#define WSOPTARGMEMORYSIZEVALIDATEMAX 262384 
#define WSOPTARGMEMORYSIZERESTARTREQUIRED 1

// Define WSLINEBUFFERSIZE
int WSLINEBUFFERSIZE;
#define DEFAULTWSLINEBUFFERSIZE 8192
#define WSLINEBUFFERSIZETAG "WSLINEBUFFERSIZE"
#define WSLINEBUFFERSIZEHELP "The max number of bytes we can handle a single header line can be (including the GET line). This is normally in the order of 16K - 128K"
#define WSLINEBUFFERSIZEVALIDATESTRING 0
#define WSLINEBUFFERSIZEVALIDATEMIN 1024
#define WSLINEBUFFERSIZEVALIDATEMAX 262384
#define WSLINEBUFFERSIZERESTARTREQUIRED 1
...
#define VERSIONRETAINDAYSHELP "Days to retain versions of file/objects before final deletion, 0 = no versioning"
...
#define DELETEMAXTHREADSVALIDATEMAX 256 
#define DELETEMAXTHREADSRESTARTREQUIRED 0 
...
// Define DELETIONINTERVAL
int DELETIONINTERVAL;  
#define DEFAULTDELETIONINTERVAL 3600 
#define DELETIONINTERVALTAG "Interval between deletion cycles"
#define DELETIONINTERVALHELP "Interval to wait between deletion cycles"
#define DELETIONINTERVALVALIDATESTRING 0
#define DELETIONINTERVALVALIDATEMIN 0 
#define DELETIONINTERVALVALIDATEMAX 999999 
#define DELETIONINTERVALRESTARTREQUIRED 0

// Define UPLOADSPURGESTALE
int UPLOADSPURGESTALE;  
#define DEFAULTUPLOADSPURGESTALE 1 
#define UPLOADSPURGESTALETAG "Purge Stale Uploads"
#define UPLOADSPURGESTALEHELP "Enable purging of stale content server (s3) uploads"
#define UPLOADSPURGESTALEVALIDATESTRING 0
#define UPLOADSPURGESTALEVALIDATEMIN 0 
#define UPLOADSPURGESTALEVALIDATEMAX 1 
#define UPLOADSPURGESTALERESTARTREQUIRED 0 

// Define UPLOADSPURGESTALEAFTER
int UPLOADSPURGESTALEAFTER;  
#define DEFAULTUPLOADSPURGESTALEAFTER 86400
#define UPLOADSPURGESTALEAFTERTAG "Purge Stale Uploads After"
#define UPLOADSPURGESTALEAFTERHELP "Seconds to wait before purging incomplete content server (s3) uploads"
#define UPLOADSPURGESTALEAFTERVALIDATESTRING 0
#define UPLOADSPURGESTALEAFTERVALIDATEMIN 60 
#define UPLOADSPURGESTALEAFTERVALIDATEMAX 7776000 
#define UPLOADSPURGESTALEAFTERRESTARTREQUIRED 0 

// Define UPLOADSPURGEINTERVAL
int UPLOADSPURGEINTERVAL;  
#define DEFAULTUPLOADSPURGEINTERVAL 3600 
#define UPLOADSPURGEINTERVALTAG "Interval between purge upload cycles"
#define UPLOADSPURGEINTERVALHELP "Interval to wait between purging stale uploads cycles"
#define UPLOADSPURGEINTERVALVALIDATESTRING 0
#define UPLOADSPURGEINTERVALVALIDATEMIN 0 
#define UPLOADSPURGEINTERVALVALIDATEMAX 999999 
#define UPLOADSPURGEINTERVALRESTARTREQUIRED 0 
...
// Define AUTORELESEDATAFILEMS - Not in use 
...
// Define ENABLEMGMTSOCKET
int ENABLEMGMTSOCKET;
#define DEFAULTENABLEMGMTSOCKET "1"
#define ENABLEMGMTSOCKETTAG "ENABLEMGMTSOCKET"
#define ENABLEMGMTSOCKETHELP "Enable the management socket for nexfscli"
#define ENABLEMGMTSOCKETVALIDATESTRING 0
#define ENABLEMGMTSOCKETVALIDATEMIN 0
#define ENABLEMGMTSOCKETVALIDATEMAX 1
#define ENABLEMGMTSOCKETRESTARTREQUIRED 0

// Define MGMTSOCKETPATH
char ENABLEMGMTSOCKETPATH[2048];
#define DEFAULTENABLEMGMTSOCKETPATH "/var/run/nexfs/nexfsd"
#define ENABLEMGMTSOCKETPATHTAG "ENABLEMGMTSOCKETPATH"
#define ENABLEMGMTSOCKETPATHHELP "The path to the management socket for nexfscli"
#define ENABLEMGMTSOCKETPATHVALIDATESTRING 1
#define ENABLEMGMTSOCKETPATHVALIDATEMIN 0
#define ENABLEMGMTSOCKETPATHVALIDATEMAX 2048
#define ENABLEMGMTSOCKETPATHRESTARTREQUIRED 0
...
#define SECURITYCMDGROUPHELP "User Group of which members can run nexfs admin commands"
...
#define SECURITYCMDGROUPACCESSHELP "User Group for which members can run nexfs admin commands, 0=no access, 1 read only, 2 read/write"
...
#define SECURITYCONFGROUPHELP "User Group for which members can run nexfs admin configuration commands"
...
#define SECURITYCONFGROUPACCESSHELP "User Group of which members can view and make nexfs configuration changes, 0=no access, 1 read only, 2 read/write"
...
#define ISCSIIOTHREADSHELP "Number of Integrated iSCSI target IO Threads" 
...
#define ISCSIMAXLUNSHELP "Maximum number of iSCSI Luns per Target supported by the Integrated iSCSI Server"
...
#define ISCSIMAXBINDINGSHELP "Number of Target to Interface bindings supported by the Integrated iSCSI Server" 
...
#define DEFAULTISCSIMAXINTERFACES "8"
#define ISCSIMAXINTERFACESTAG "ISCSIMAXINTERFACES"
#define ISCSIMAXINTERFACESHELP "Maximum number of Integrated iSCSI network interfaces (portals) supported"
#define ISCSIMAXINTERFACESVALIDATESTRING 0
#define ISCSIMAXINTERFACESVALIDATEMIN 1
#define ISCSIMAXINTERFACESVALIDATEMAX 128 
...
// Define ISCSIENABLETGTADM
int ISCSIENABLETGTADM;
#define DEFAULTISCSIENABLETGTADM "1"
#define ISCSIENABLETGTADMTAG "ISCSIENABLETGTADM"
#define ISCSIENABLETGTADMHELP "Enable or disable the use of tgtadm for iSCSI target information"
#define ISCSIENABLETGTADMVALIDATESTRING 0
#define ISCSIENABLETGTADMVALIDATEMIN 0
#define ISCSIENABLETGTADMVALIDATEMAX 1
#define ISCSIENABLETGTADMRESTARTREQUIRED 0

// Define ISCSIPORTTGTADM
int ISCSIPORTTGTADM;
#define DEFAULTISCSIPORTTGTADM "0"
#define ISCSIPORTTGTADMTAG "ISCSIPORTTGTADM"
#define ISCSIPORTTGTADMHELP "The socket number for tgtadm to request iSCSI target information"
#define ISCSIPORTTGTADMVALIDATESTRING 0
#define ISCSIPORTTGTADMVALIDATEMIN 0
#define ISCSIPORTTGTADMVALIDATEMAX 65535
#define ISCSIPORTTGTADMRESTARTREQUIRED 0

// Define ISCSIDIRIPC
char ISCSIDIRIPC[128];
#define DEFAULTISCSIDIRIPC "/var/run/nexfs"
#define ISCSIDIRIPCTAG "ISCSIDIRIPC"
#define ISCSIDIRIPCHELP "Location where Nexfs creates the iSCSI IPC socket"
#define ISCSIDIRIPCVALIDATESTRING 1
#define ISCSIDIRIPCVALIDATEMIN 0
#define ISCSIDIRIPCVALIDATEMAX 128 
#define ISCSIDIRIPCRESTARTREQUIRED 0

// Define ISCSIDIRIPCTGTADM
char ISCSIDIRIPCTGTADM[128];
#define DEFAULTISCSIDIRIPCTGTADM "/var/run/tgtd"
#define ISCSIDIRIPCTGTADMTAG "ISCSIDIRIPCTGTADM"
#define ISCSIDIRIPCTGTADMHELP "Location where nexfs optionally creates the a symlink to ease iSCSI IPC socket tgtadm communication"
#define ISCSIDIRIPCTGTADMVALIDATESTRING 1
#define ISCSIDIRIPCTGTADMVALIDATEMIN 0
#define ISCSIDIRIPCTGTADMVALIDATEMAX 128 
#define ISCSIDIRIPCTGTADMRESTARTREQUIRED 0
...
// Define S3ABORTUPLOADONCREATE
int S3ABORTUPLOADONCREATE;
#define DEFAULTS3ABORTUPLOADONCREATE "1"
#define S3ABORTUPLOADONCREATETAG "Abort Upload on Create"
#define S3ABORTUPLOADONCREATEHELP "Abort a initiated incomplete multipartupload when receiving a new Create Multipart request for the same key"
#define S3ABORTUPLOADONCREATEVALIDATESTRING 0 
#define S3ABORTUPLOADONCREATEVALIDATEMIN 0 
#define S3ABORTUPLOADONCREATEVALIDATEMAX 1 
#define S3ABORTUPLOADONCREATERESTARTREQUIRED 0 

// Define S3ALLOWOVERWRITENOVERSIONING
int S3ALLOWOVERWRITENOVERSIONING;
#define DEFAULTS3ALLOWOVERWRITENOVERSIONING "0"
#define S3ALLOWOVERWRITENOVERSIONINGTAG "Allow Overwrite No Versioning"
#define S3ALLOWOVERWRITENOVERSIONINGHELP "Allow S3 requests to overwrite existing objects when versioning is disabled"
#define S3ALLOWOVERWRITENOVERSIONINGVALIDATESTRING 0
#define S3ALLOWOVERWRITENOVERSIONINGVALIDATEMIN 0
#define S3ALLOWOVERWRITENOVERSIONINGVALIDATEMAX 1
#define S3ALLOWOVERWRITENOVERSIONINGRESTARTREQUIRED 0
...
#define WSCONNECTIONIDLETIMEOUTSECONDSHELP "Number of seconds after which to timeout a client web server connection which has stopped sending traffic"
